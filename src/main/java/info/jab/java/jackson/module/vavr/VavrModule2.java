package info.jab.java.jackson.module.vavr;
...
public class VavrModule2 extends SimpleModule {
    ...
    public VavrModule2(Settings settings) {
    ...
    public void setupModule(SetupContext context) {
        ...
        context.addSerializers(new VavrSerializers2(settings));
        context.addDeserializers(new VavrDeserializers2(settings));
