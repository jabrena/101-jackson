...
public class VavrDeserializers2 extends Deserializers.Base {

    private final VavrModule2.Settings settings;

    public VavrDeserializers2(VavrModule2.Settings settings) {
