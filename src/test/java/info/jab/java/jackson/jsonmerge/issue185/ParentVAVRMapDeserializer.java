...
public class ParentVAVRMapDeserializer extends JsonDeserializer<Map<String, String>> {
    ...
    public Map<String, String> deserialize(JsonParser p, DeserializationContext ctxt) throws IOException {
        ...
        // Get current map from the ParentVAVR instance
        ...
        if (currentValue instanceof ParentVAVR) {
            ...
            currentMap = parent.map != null ? parent.map : HashMap.empty();
        }
